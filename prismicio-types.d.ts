...
/**
 * Primary content in *Desplegar → Primary*
 */
export interface DesplegarSliceDefaultPrimary {
  /**
   * Visit field in *Desplegar → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: desplegar.primary.visit
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  visit: prismic.KeyTextField;

  /**
   * Visit Link field in *Desplegar → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: desplegar.primary.visit_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  visit_link: prismic.LinkField;
}

/**
 * Default variation for Desplegar Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type DesplegarSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<DesplegarSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *Desplegar*
 */
type DesplegarSliceVariation = DesplegarSliceDefault;

/**
 * Desplegar Shared Slice
 *
 * - **API ID**: `desplegar`
 * - **Description**: Desplegar
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type DesplegarSlice = prismic.SharedSlice<
  "desplegar",
  DesplegarSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      DesplegarSlice,
      DesplegarSliceDefaultPrimary,
      DesplegarSliceVariation,
      DesplegarSliceDefault,
      ExperienceSlice,
